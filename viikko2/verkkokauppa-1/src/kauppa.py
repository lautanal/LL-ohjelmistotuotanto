...
from viitegeneraattori import viitegeneraattori as default_viiteg

seuraava = 1

class Kauppa:
    def __init__(self, varasto=default_varasto, pankki=default_pankki, viitegeneraattori=default_viiteg):
